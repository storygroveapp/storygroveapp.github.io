const translations = {
    ru: {
        ...
        downloadAndroid: "Скачать APK", downloadRuStore: "Скачать в RuStore", supportProject: "Поддержать проект", releaseLoading: "Проверяем доступную версию…", releasePending: "APK пока недоступен", releaseInfo: "Версия {version} · {size} · {requirements}", trustOffline: "Работает офлайн", trustFree: "Бесплатно", trustLocal: "Данные на устройстве",
        altCampaign: "Центральный экран-превью StoryGrove", altCharacters: "Левый экран-превью StoryGrove", altCharacter: "Правый экран-превью StoryGrove",
    ...
    en: {
        ...
        downloadAndroid: "Download APK", downloadRuStore: "Get it on RuStore", supportProject: "Support the project", releaseLoading: "Checking the available version…", releasePending: "The APK is not available yet", releaseInfo: "Version {version} · {size} · {requirements}", trustOffline: "Works offline", trustFree: "Free to use", trustLocal: "Data stays on device",
        altCampaign: "Center StoryGrove preview screen", altCharacters: "Left StoryGrove preview screen", altCharacter: "Right StoryGrove preview screen",
